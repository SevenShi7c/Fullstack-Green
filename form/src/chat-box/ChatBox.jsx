      ...
      <>
        <div className="fixed bottom-0 right-0 flex flex-col items-end ml-6 w-full">
          <div className="chat-modal show  mr-5 flex flex-col mb-5 shadow-lg sm:w-1/2 md:w-1/3 lg:w-1/4 ">
            ...
            <div
              className="flex justify-between items-center text-white p-2 bg-green-500 border shadow-lg mr-5 w-full"
              onClick={this.handleCloseChat}
            >
            ...
            >
              ...
              <div className="relative bg-white bottom-0">
                <input
                  type="text"
                  name="message"
                  placeholder="ketik pesan anda"
                  className="input-text pl-4 pr-16 py-2 border border-green-500 focus:outline-none w-full"
                  onChange={this.handleChangeInput}
                />
                <button
                  className="absolute right-0 bottom-0 text-green-600 bg-white  hover:text-green-500 m-1 px-3 py-1 w- transistion-color duration-100 focus:outline-none"
